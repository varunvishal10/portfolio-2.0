$(document).ready(function () {
  ...
  var searchField = $('#js-search-input').ghostHunter({
    ...
    result_template:
      '<div id="{{ref}}" class="search-results__item gh-search-item"><a class="search-results__link" href="{{link}}"><div class="result-title">{{title}}</div><span class="search-results-date">{{pubDate}}</span></a></div>'
  });
  ...
  $load_posts_button.click(function (e) {
    ...
    $.ajax({
      ...
      $load_posts_button.text('Load More Posts').append('<i class="ion ion-ios-arrow-down"></i>');
